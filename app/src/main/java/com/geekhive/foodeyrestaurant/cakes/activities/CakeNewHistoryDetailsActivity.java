...
public class CakeNewHistoryDetailsActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewAllItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CakeNewHistoryDetailsActivity.this, CakeViewOrderDetailsActivity.class);
