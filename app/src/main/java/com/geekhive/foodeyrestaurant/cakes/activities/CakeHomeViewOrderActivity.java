...
import com.geekhive.foodeyrestaurant.cakes.adapter.CakeHomeOrderDetailAdapter;
...
public class CakeHomeViewOrderActivity extends AppCompatActivity implements OnResponseListner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cake_activity_home_view_order);
        ...
        if (apiType == WebServices.ApiType.orderdetailhistory) {
            if (!isSuccess) {
                ...
                if (!isSuccess || orderDetailHistory == null) {
                    ...
                    CakeHomeOrderDetailAdapter homeAdapter = new CakeHomeOrderDetailAdapter(this,orderDetailHistory);
