...
public class Prefs {
    ...
    static final String PREF_OPEN_CLOSE_TB = "open_close_tb";
    static final String PREF_OPEN_CLOSE_TA = "open_close_tA";
    static final String PREF_ON_OFF = "on_off";
    static final String PREF_REST_LOGIN = "restlogin";
    ...
    public static void setOpenCloseTB(Context ctx, String s) {
        getPrefs(ctx).edit().putString(PREF_OPEN_CLOSE_TB, s).commit();
    }


    public static String getOpenCloseTB(Context ctx) {
        return getPrefs(ctx).getString(PREF_OPEN_CLOSE_TB, "");
    }

    public static void setOpenCloseTA(Context ctx, String s) {
        getPrefs(ctx).edit().putString(PREF_OPEN_CLOSE_TA, s).commit();
    }


    public static String getOpenCloseTA(Context ctx) {
        return getPrefs(ctx).getString(PREF_OPEN_CLOSE_TA, "");
    }

    public static void setOnOff(Context ctx, String s) {
        getPrefs(ctx).edit().putString(PREF_ON_OFF, s).commit();
    }


    public static String getOnOff(Context ctx) {
        return getPrefs(ctx).getString(PREF_ON_OFF, "");
    }
...
/* Global server user id */
    ...
    public static void setRestLogin(Context ctx, String s) {
        getPrefs(ctx).edit().putString(PREF_REST_LOGIN, s).commit();
    }


    public static String getRestLogin(Context ctx) {
        return getPrefs(ctx).getString(PREF_REST_LOGIN, "");
    }
