...
public class Grocery_OrderListAdapter extends RecyclerView.Adapter<Grocery_OrderListAdapter.MyViewHolder> {

    Context context;
    ArrayList<String> customerName;

    public Grocery_OrderListAdapter(Context context) {
