...
public class Grocery_OrdersAdapter extends RecyclerView.Adapter<Grocery_OrdersAdapter.MyViewHolder> {

    Context context;
    ArrayList<String> orderReceived;

    public Grocery_OrdersAdapter(Context context, ArrayList<String> orderReceived) {
