...
public class Grocery_SplashScreenActivity extends AppCompatActivity {
...
//        ButterKnife.bind(this);
    ...
    private void splashScreenCall() {
        ...
        mRunnableTimeOut = new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(Grocery_SplashScreenActivity.this, Grocery_BottomNaviActivity.class);
...
//                finish();
    ...
    private boolean mayRequestReadWriteSd() {
        ...
        if (ContextCompat.checkSelfPermission(Grocery_SplashScreenActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) + ContextCompat
                .checkSelfPermission(Grocery_SplashScreenActivity.this,
        ...
        switch (requestCode) {
            case REQUEST_FOR_STORAGE_PERMISSION:
                ...
                if (grantResults.length > 0) {
                    ...
                    if (grantResults[0] == PackageManager.PERMISSION_GRANTED && grantResults[1] == PackageManager.PERMISSION_GRANTED) {
                        ...
                        if (ActivityCompat.shouldShowRequestPermissionRationale(Grocery_SplashScreenActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) ||
                                ActivityCompat.shouldShowRequestPermissionRationale
                                        (Grocery_SplashScreenActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                            showPermissionRationaleSnackBar();
                        } else {
                            Toast.makeText(Grocery_SplashScreenActivity.this, "Go to settings and enable permission", Toast.LENGTH_LONG).show();
                        }
                    }
                }
                break;
            case MY_PERMISSIONS_REQUEST_LOCATION:
                ...
                if (grantResults.length > 0
                    ...
                    SnackBar.makeText(Grocery_SplashScreenActivity.this, "Please accept location permission", SnackBar.LENGTH_SHORT).setAction("Accept", new LocationListener()).show();
                    return;
                }
                break;
        ...
        Snackbar.make(findViewById(android.R.id.content),
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ActivityCompat.requestPermissions(Grocery_SplashScreenActivity.this,
                                new String[]{Manifest.permission
                                        .WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE},
                                REQUEST_FOR_STORAGE_PERMISSION);
                    }
